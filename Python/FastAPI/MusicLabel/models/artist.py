...
class ArtistCreate(BaseModel):
    name: str                 # pas de valeur par défaut => champ obligatoire
    genre: str
    country: str
    active: bool = True       # valeur par défaut => champ optionnel dans le JSON
    # Règle Python : les champs avec défaut doivent venir APRÈS ceux sans défaut.
